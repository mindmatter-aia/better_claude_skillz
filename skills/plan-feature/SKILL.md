...
- Locate configuration files (pyproject.toml, package.json, composer.json, etc.)
...
- Find relevant documentation in docs/, .claude/reference/ or other project docs
- Note library versions and compatibility requirements

**4. Testing Patterns**

- Identify test framework and structure (pytest, jest, PHPUnit, etc.)
...
**Archive**: After implementation, move completed plans to `.claude/plans/archive/`
